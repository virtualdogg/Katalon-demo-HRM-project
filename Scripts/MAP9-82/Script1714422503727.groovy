...
WebUI.setText(findTestObject('Object Repository/input_search_menuQuickSearchmenuQuickSearch'), 'educatio')

WebUI.click(findTestObject('Object Repository/div_Education'))

WebUI.click(findTestObject('Object Repository/td_ohrm_edit'))

WebUI.click(findTestObject('Object Repository/a_Cancel'))

WebUI.click(findTestObject('Object Repository/i_ohrm_edit'))

WebUI.setText(findTestObject('Object Repository/input_Add Education_name'), 'Bachelor’s or equivalent edit')
