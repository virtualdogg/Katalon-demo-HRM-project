...
WebUI.setText(findTestObject('Object Repository/Job Categories/Page_Job/input_Add Job Category_name'), JC)

WebUI.click(findTestObject('Object Repository/Job Categories/Page_Job/a_Save'))

WebUI.verifyElementText(findTestObject('Object Repository/Job Categories/Page_Job/div_Successfully Saved'), 'Successfully Saved')
