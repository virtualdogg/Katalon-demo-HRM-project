...
//WebUI.click(findTestObject('Object Repository/span_Already exists'))

WebUI.click(findTestObject('Object Repository/div_Level of Education Already exists'))

String text = WebUI.getText(findTestObject('Object Repository/div_Level of Education Already exists'))



//WebUI.click(findTestObject('Object Repository/span_Already exists'))

WebUI.verifyElementText(findTestObject('Object Repository/span_Already exists'), 'Already exists')

WebUI.click(findTestObject('Object Repository/a_Save'))
if(text.contains("Already exists")) {
	println("Eureka! I found the error! :) ")
  } else {
	println("Sorry, The error is not around :( ")
  }
