...
WebUI.doubleClick(findTestObject('Object Repository/Job Categories/Page_Job/span_Software Engineer'))

WebUI.click(findTestObject('Object Repository/Job Categories/Page_Job/body_ohrm_settings                         _bb91cf'))

WebUI.click(findTestObject('Object Repository/Job Categories/Page_Job/body_ohrm_settings                         _bb91cf'))

WebUI.click(findTestObject('Object Repository/Job Categories/Page_Job/i_add'))

WebUI.click(findTestObject('Object Repository/Job Categories/Page_Job/label_Name'))

WebUI.setText(findTestObject('Object Repository/Job Categories/Page_Job/input_Add Job Category_name'), 'Software Engineer')

WebUI.verifyElementText(findTestObject('Object Repository/Job Categories/Page_Job/span_Already exists'), 'Already exists')

WebUI.verifyElementPresent(findTestObject('Object Repository/Job Categories/Page_Job/span_Already exists'), 0)

WebUI.click(findTestObject('Object Repository/Job Categories/Page_Job/a_Save'))
