...
WebUI.setEncryptedText(findTestObject('Object Repository/input_Login_txtPassword'), 'KrkDuQ1ShVHT8qMxAUxOKA==')

WebUI.click(findTestObject('Object Repository/img_Login_icon show-icon'))
