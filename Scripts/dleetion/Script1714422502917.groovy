...
WebUI.click(findTestObject('Object Repository/i_more_horiz'))

WebUI.click(findTestObject('Object Repository/a_Delete Selected'))

WebUI.click(findTestObject('Object Repository/a_Yes, Delete'))
